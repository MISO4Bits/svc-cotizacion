...
def sanear_para_log(valor: str) -> str:
    """Quita saltos de línea de un valor que viene del cliente (header o
    ...
    URL o en un header permite falsificar líneas de log completas
    (CWE-117 / log injection, pythonsecurity:S5145).
    """
