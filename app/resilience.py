...
- **Timeout** por llamada (httpx) — presupuesto duro: 700 ms por dependencia (BITS-80 / EXP-02).
...
- **Circuit breaker** por dependencia: tras N fallos abre el circuito y falla rápido
  durante ``reset_timeout`` en vez de castigar la latencia del journey. En HALF_OPEN
